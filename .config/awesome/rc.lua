...
local mid_sep = wibox.widget.textbox(" ][ ")
                ...
                {
                    {
                        ...
                        {
                            -- Makes no Sense
                            -- Dunno how this gives text but it does so who cares.
                            id     = 'text_role',
...
globalkeys = gears.table.join(
    ...
    -- Custom keybindings.
    awful.key({ modkey }, "t", function () awful.spawn.with_shell("firefox")    end,
...
awful.rules.rules = {
    ...
    { rule_any = {
      ...
      }, properties = { floating = false }}, -- change to true if you want floating.
...
-- 
-- Uncomment to add back ugly title bars.
-- Also set titlebars_enabled to true in rules (ctrl+f it)
-- 
